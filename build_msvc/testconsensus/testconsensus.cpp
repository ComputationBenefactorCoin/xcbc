...
// xcbc includes.
#include <..\src\script\xcbcconsensus.h>
...
int main()
{
    std::cout << "xcbcconsensus version: " << xcbcconsensus_version() << std::endl;
    ...
    auto op0Result = xcbcconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, xcbcconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
