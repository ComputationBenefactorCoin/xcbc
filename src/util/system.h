 ...
 */
#ifndef XCBC_UTIL_SYSTEM_H
#define XCBC_UTIL_SYSTEM_H
...
extern const char * const XCBC_CONF_FILENAME;
extern const char * const XCBC_SETTINGS_FILENAME;
