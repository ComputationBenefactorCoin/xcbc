...
{
    BOOST_CHECK(TestSplitHost("www.computationbenefactorcoin.com", "www.computationbenefactorcoin.com", 0));
    BOOST_CHECK(TestSplitHost("[www.computationbenefactorcoin.com]", "www.computationbenefactorcoin.com", 0));
    BOOST_CHECK(TestSplitHost("www.computationbenefactorcoin.com:80", "www.computationbenefactorcoin.com", 80));
    BOOST_CHECK(TestSplitHost("[www.computationbenefactorcoin.com]:80", "www.computationbenefactorcoin.com", 80));
