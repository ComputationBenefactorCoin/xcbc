...
#ifndef XCBC_TEST_SCRIPTNUM10_H
#define XCBC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from XCBC Core 0.10.0, for cross-comparison.
 */
public:
