...
#ifndef XCBC_SCRIPT_STANDARD_H
#define XCBC_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a xcbc address
 */
...
/**
 * Generate a XCBC scriptPubKey for the given CTxDestination. Returns a P2PKH
