...
#ifndef XCBC_CRYPTO_CHACHA_POLY_AEAD_H
#define XCBC_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@xcbc.
 *
 ...
 *
 * The chacha20-poly1305@xcbc combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@xcbc cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@xcbc are relatively fast in
...
#endif // XCBC_CRYPTO_CHACHA_POLY_AEAD_H
