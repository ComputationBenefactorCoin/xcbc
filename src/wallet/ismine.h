...
#ifndef XCBC_WALLET_ISMINE_H
#define XCBC_WALLET_ISMINE_H
 ...
 * https://github.com/ComputationBenefactorCoin/xcbc/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
