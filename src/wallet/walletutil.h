...
#ifndef XCBC_WALLET_WALLETUTIL_H
#define XCBC_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! xcbc from opening the wallet, thinking it was newly created, and
...
#endif // XCBC_WALLET_WALLETUTIL_H
