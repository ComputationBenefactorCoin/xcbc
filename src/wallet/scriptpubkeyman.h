...
#ifndef XCBC_WALLET_SCRIPTPUBKEYMAN_H
#define XCBC_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The XCBC Core wallet was originally a collection of unrelated private
...
#endif // XCBC_WALLET_SCRIPTPUBKEYMAN_H
