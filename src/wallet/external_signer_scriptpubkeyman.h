...
#ifndef XCBC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define XCBC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // XCBC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
