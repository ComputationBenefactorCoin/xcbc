...
//! Entry point for XCBCApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &XCBCApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for XCBCGUI tests.
void AppTests::guiTests(XCBCGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &XCBCGUI::consoleShown, this, &AppTests::consoleTests);
