    ...
    platformStyle(_platformStyle)
{
    ...
    // normal xcbc address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying xcbc address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &XCBCAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
