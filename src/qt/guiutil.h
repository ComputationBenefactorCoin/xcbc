...
#ifndef XCBC_QT_GUIUTIL_H
#define XCBC_QT_GUIUTIL_H
...
/** Utility functions used by the XCBC Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "xcbc:" URI into recipient object, return true on successful parsing
