    ...
    mapper(nullptr)
{
    ...
    ui->xcbcAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->xcbcAtStartup);
    ...
    ui->xcbcAtStartup->setToolTip(ui->xcbcAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->xcbcAtStartup->setText(ui->xcbcAtStartup->text().arg(PACKAGE_NAME));

    ui->openXCBCConfButton->setToolTip(ui->openXCBCConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new XCBCUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->xcbcAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openXCBCConfButton_clicked()
{
