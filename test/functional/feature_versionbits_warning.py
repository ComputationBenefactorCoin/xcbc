...
class VersionBitsWarningTest(XCBCTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because xcbcd will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
