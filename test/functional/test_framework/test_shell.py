...
class TestShell:
    """Wrapper Class for XCBCTestFramework.

    The TestShell class extends the XCBCTestFramework
    ...
    class __TestShell(XCBCTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by XCBCTestFramework child class.
            self.num_nodes = 1
