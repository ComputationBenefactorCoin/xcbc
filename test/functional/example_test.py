...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the XCBCTestFramework
    pass


class ExampleTest(XCBCTestFramework):
    # Each functional test is a subclass of the XCBCTestFramework class.
    ...
    def custom_method(self):
        ...
        XCBCTestFramework class so other tests can use it."""
