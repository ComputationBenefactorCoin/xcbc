...
By default, xcbcd will dump mempool on shutdown and
...
class MempoolPersistTest(XCBCTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent xcbcd from writing mempool.dat to disk. Verify that `savemempool` fails")
