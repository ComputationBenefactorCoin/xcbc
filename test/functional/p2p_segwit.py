...
class SegWitTest(XCBCTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older xcbcd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let xcbcd fill it in.
