...
class P2PPermissionsTests(XCBCTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].xcbcconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].xcbcconf, 'w', encoding="utf8") as f:
            f.write(newText)
