...
"""Verify that starting xcbc with -h works as expected."""

from test_framework.test_framework import XCBCTestFramework
from test_framework.util import assert_equal

class HelpTest(XCBCTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xcbc with -h for help text")
        ...
        self.log.info("Start xcbc with -version for version information")
        ...
        self.log.info("Start xcbcd with -fakearg to make sure it does not start")
