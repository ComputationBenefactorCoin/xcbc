...
Verify that a xcbcd node can use an external signer command.
...
class RPCSignerTest(XCBCTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart xcbcd with -signer=<cmd>',
