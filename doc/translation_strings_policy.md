...
This document provides guidelines for internationalization of the XCBC Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xcbc_en.ts` remains unchanged.
