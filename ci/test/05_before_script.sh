...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/XCBC
else
  DOCKER_EXEC echo \> \$HOME/.xcbc
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/ComputationBenefactorCoin/xcbc/pull/18288#discussion_r433189350 for
  # details.
