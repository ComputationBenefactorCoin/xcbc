...
Arguments:
    <base_directory> - The base directory of a xcbc source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The XCBC Core developers'
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The XCBC Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the xcbc repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The XCBC
