...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef XCBC_CHAINPARAMSSEEDS_H\n')
    g.write('#define XCBC_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the xcbc network\n')
    ...
    g.write('#endif // XCBC_CHAINPARAMSSEEDS_H\n')
