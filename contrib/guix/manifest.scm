...
(define* (make-xcbc-cross-toolchain target
                                       #:key
...
desirable for building XCBC Core release binaries."
...
(define glibc-2.27/xcbc-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-xcbc-cross-toolchain target
                                                      #:base-libc glibc-2.27/xcbc-patched
