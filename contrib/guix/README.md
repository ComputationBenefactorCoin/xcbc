# Bootstrappable XCBC Core Builds

This directory contains the files necessary to perform bootstrappable XCBC
Core builds.
...
To build XCBC Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/xcbc-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/ComputationBenefactorCoin/xcbc/guix.sigs).
