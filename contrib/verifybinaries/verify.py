...
computationbenefactorcoin.com and computationbenefactorcoin.com and compares them.
...
WORKINGDIR = "/tmp/xcbc_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://computationbenefactorcoin.com"
HOST2 = "https://computationbenefactorcoin.com"
VERSIONPREFIX = "xcbc-core-"
...
def main(args):
    ...
    if not success:
        print("computationbenefactorcoin.com failed to provide signature file, "
              "but computationbenefactorcoin.com did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("computationbenefactorcoin.com and computationbenefactorcoin.com signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the XCBC Core binary release "
