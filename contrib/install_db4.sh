...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the xcbc repository."
  exit 1
fi
...
# See https://github.com/ComputationBenefactorCoin/xcbc/issues/16064
...
echo 'When compiling xcbcd, run `./configure` in the following way:'
echo
